            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                <li class="nav-item menu-open">
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="{{route('forms.index')}}" class="nav-link active"> <i class="nav-icon bi bi-list"></i>
                                <p>Index</p>
                            </a> </li>
                        <li class="nav-item"> <a href="{{route('forms.create')}}" class="nav-link"> <i class="nav-icon bi bi-pen"></i>
                                <p>Create Form</p>
                            </a> </li>
                    </ul>
                </li>
